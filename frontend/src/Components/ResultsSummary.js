  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm mb-6">
      <h3 className="font-bold text-gray-800 mb-6 text-xl flex items-center gap-2">
        ...
        Keyness Analysis Results
      </h3>

      <div className="mb-6 p-4 bg-blue-50 rounded-lg">
        <div className="grid md:grid-cols-3 gap-4 text-center">
          <div>
            <div className="text-2xl font-bold text-blue-600">{results.uploaded_total}</div>
            <div className="text-sm text-gray-600">Words in your text</div>
          </div>
          <div>
            <div className="text-2xl font-bold text-green-600">{results.sample_total}</div>
